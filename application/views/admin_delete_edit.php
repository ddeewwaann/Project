    ...
    <body>
        ...
        <section>
            <div class="container-fluid">
                <center><a class="btn btn-primary" href="<?php echo base_url('index.php/webController/delete1') ?>">DELETE ALL TABLE</a></center>
                <div class="row">
                    <div class="col-11">
                            ...
                            <tbody>
                                <tr><?php foreach ($sanblast as $sbt) : ?>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url(); ?>index.php/webController/delete_data/<?= $sbt['waktu'] ?>/sanblast " class="badge badge-danger float-center" onclick="return confirm('Are you sure want to delete the data ? ');" ?>DELETE</a>
                                        <a href="<?= base_url(); ?>index.php/webController/edit_getdata/<?= $sbt['waktu'] ?>/sanblast" class="badge badge-success float-center" ?>EDIT</a>
                                    </td>
                                </tr>
                                <?php endforeach;?>
                            </tbody>
                ...
                <tbody>
                    <tr><?php foreach ($phospating as $pst) : ?>
                            ...
                            <td class="text-center">
                                        <a href="<?= base_url(); ?>index.php/webController/delete_data/<?= $pst['waktu'] ?>/phospating " class="badge badge-danger float-center" onclick="return confirm('Are you sure want to delete the data ? ');" ?>DELETE</a>
                                        <a href="<?= base_url(); ?>index.php/webController/edit_getdata/<?= $pst['waktu'] ?>/phospating" class="badge badge-success float-center" ?>EDIT</a>
                                    </td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
                ...
                <tbody>
                    <tr><?php foreach ($bonding as $bdg) : ?>
                            ...
                            <td class="text-center">
                                        <a href="<?= base_url(); ?>index.php/webController/delete_data/<?= $bdg['waktu'] ?>/bonding " class="badge badge-danger float-center" onclick="return confirm('Are you sure want to delete the data ? ');" ?>DELETE</a>
                                        <a href="<?= base_url(); ?>index.php/webController/edit_getdata/<?= $bdg['waktu'] ?>/bonding" class="badge badge-success float-center" ?>EDIT</a>
                                    </td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
                ...
                <tbody>
                    <tr><?php foreach ($pressing as $prs) : ?>
                            ...
                            <td class="text-center">
                                        <a href="<?= base_url(); ?>index.php/webController/delete_data/<?= $prs['waktu'] ?>/pressing " class="badge badge-danger float-center" onclick="return confirm('Are you sure want to delete the data ? ');" ?>DELETE</a>
                                        <a href="<?= base_url(); ?>index.php/webController/edit_getdata/<?= $prs['waktu'] ?>/pressing" class="badge badge-success float-center" ?>EDIT</a>
                                    </td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
                ...
                <tbody>
                    <tr><?php foreach ($assembly1 as $asb1) : ?>
                            ...
                            <td class="text-center">
                                        <a href="<?= base_url(); ?>index.php/webController/delete_data/<?= $asb1['waktu'] ?>/assembly1 " class="badge badge-danger float-center" onclick="return confirm('Are you sure want to delete the data ? ');" ?>DELETE</a>
                                        <a href="<?= base_url(); ?>index.php/webController/edit_getdata/<?= $asb1['waktu'] ?>/assembly1" class="badge badge-success float-center" ?>EDIT</a>
                                    </td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
                ...
                <tbody>
                    <tr><?php foreach ($machining as $mcg) : ?>
                            ...
                            <td class="text-center">
                                        <a href="<?= base_url(); ?>index.php/webController/delete_data/<?= $mcg['waktu'] ?>/machining " class="badge badge-danger float-center" onclick="return confirm('Are you sure want to delete the data ? ');" ?>DELETE</a>
                                        <a href="<?= base_url(); ?>index.php/webController/edit_getdata/<?= $mcg['waktu'] ?>/machining" class="badge badge-success float-center" ?>EDIT</a>
                                    </td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
                ...
                <tbody>
                    <tr><?php foreach ($frictionwelding as $fwg) : ?>
                            ...
                            <td class="text-center">
                                        <a href="<?= base_url(); ?>index.php/webController/delete_data/<?= $fwg['waktu'] ?>/frictionwelding " class="badge badge-danger float-center" onclick="return confirm('Are you sure want to delete the data ? ');" ?>DELETE</a>
                                        <a href="<?= base_url(); ?>index.php/webController/edit_getdata/<?= $fwg['waktu'] ?>/frictionwelding" class="badge badge-success float-center" ?>EDIT</a>
                                    </td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
                ...
                <tbody>
                    <tr><?php foreach ($painting as $ptg) : ?>
                            ...
                            <td class="text-center">
                                        <a href="<?= base_url(); ?>index.php/webController/delete_data/<?= $ptg['waktu'] ?>/painting " class="badge badge-danger float-center" onclick="return confirm('Are you sure want to delete the data ? ');" ?>DELETE</a>
                                        <a href="<?= base_url(); ?>index.php/webController/edit_getdata/<?= $ptg['waktu'] ?>/painting" class="badge badge-success float-center" ?>EDIT</a>
                                    </td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
                ...
                <tbody>
                    <tr><?php foreach ($assembly2 as $asb2) : ?>
                            ...
                            <td class="text-center">
                                        <a href="<?= base_url(); ?>index.php/webController/delete_data/<?= $asb2['waktu'] ?>/assembly2 " class="badge badge-danger float-center" onclick="return confirm('Are you sure want to delete the data ? ');" ?>DELETE</a>
                                        <a href="<?= base_url(); ?>index.php/webController/edit_getdata/<?= $asb2['waktu'] ?>/assembly2" class="badge badge-success float-center" ?>EDIT</a>
                                    </td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
