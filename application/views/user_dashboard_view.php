                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link" href="#">SHIFT 1 <?php echo date('Y-m-d')?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('index.php/webController/user_dashboard2')?>">SHIFT 2 <?php echo date('Y-m-d')?></a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav justify-content-end">
                        <li class="nav-item dropdown ">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                 <a href="<?php echo base_url('index.php/webController/export')?>" class="dropdown-item" role="button" aria-pressed="true">CONVERT TO EXCEL</a>
